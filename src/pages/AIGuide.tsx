...
const AIGuide = () => {
  ...
  const [messages, setMessages] = useState<Array<{ role: string; content: string }>>([
    { role: "assistant", content: "Hi there! I'm your EduGuide AI companion. I'm here to help you with your studies, answer questions, and provide support whenever you need it. What's on your mind today? 💙" }
  ]);
